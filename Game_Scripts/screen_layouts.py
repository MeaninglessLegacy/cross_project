...
from Game_Scripts import ui_elements
...
def return_screen_elements(screen):
    """
    returns the elements of a screen layout so that i can be rendered
    :param screen: a string that is a key value in the dictionary of screen layouts in screen_layouts.py
    :return:
    """
